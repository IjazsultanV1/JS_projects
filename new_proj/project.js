...
const deposit =() => {
  while (true){
    ...
    if(isNaN(numberDepositAmount) || numberDepositAmount <= 0){console.log("Invalid deposit amount, try again")
    } else {
...
const getBet = (balance, lines) =>{
    while (true){
        ...
        if(isNaN(numberBet) || numberBet <= 0|| numberBet > balance / lines){console.log("Invalid Bet, try again")
        } else {
          return numberBet;
        }}
}
